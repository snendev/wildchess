...
use wildchess_game::components::{Behavior, Pattern, PieceKind, TargetMode, Team};
...
fn build_svg(kind: PieceKind, behavior: Behavior, team: Team) -> String {
    format!(
        r#"<svg
    width="1000"
    height="1000"
...
fn piece_nodes(kind: PieceKind, team: Team) -> String {
    match kind {
